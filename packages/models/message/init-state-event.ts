...
export class InitStateEvent implements flatbuffers.IUnpackableObject<InitStateEventT> {
  ...
  units(index: number, obj?: Unit): Unit | null {
    ...
    return offset
      ? (obj || new Unit()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!)
      : null;
  }
  ...
  unpack(): InitStateEventT {
    return new InitStateEventT(this.bb!.createObjList<Unit, UnitT>(this.units.bind(this), this.unitsLength()));
  }
